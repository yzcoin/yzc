...
public:
    ...
    {
        // Qinhuangcoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Qinhuangcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Qinhuangcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Qinhuangcoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Qinhuangcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Qinhuangcoin: block index flags
    enum  
    {
