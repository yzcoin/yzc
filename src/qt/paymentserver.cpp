...
const QString BITCOIN_IPC_PREFIX("Qinhuangcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Qinhuangcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Qinhuangcoin: click-to-pay handler");
    else
...
{
    // clicking on Qinhuangcoin: URLs creates FileOpen events on the Mac:
